    ...
    window.HomePage = {
                ...
                methods: {
                    ...
                    loadDeviceCards() {
                        ...
                        if (window.DEVICE_CARDS) {
                            this.deviceCards = [...window.DEVICE_CARDS];
                            // 加载卡片顺序
                            this.loadCardOrder();
                        }
                    },
        ...
        try {
                ...
                components: {
                    ...
                    'card-1x2': window.Card1x2Component,
                    'card-popup': window.CardPopupComponent,
                    ...
                    <!-- 卡片网格 -->
                    <div v-else class="device-grid" :class="{ 'edit-mode': isEditMode }">
                        <card-1x1
                    ...
                    >
                            ...
                            <div class="air-conditioner-popup">
                                ...
                                <div class="ac-section">
                                    ...
                                    <div class="ac-temp-slider">
                                        <button class="btn btn-circle btn-secondary" @click="controlAC('set_temperature', acTargetTemp - 1)">
                                            <icon-component name="minus" size="20"/>
                                        </button>
                                        <input type="range"
                                ...
                                <div class="ac-section">
                                    ...
                                    <div class="ac-mode-controls">
                                        <button class="btn btn-md btn-secondary" :class="{ 'btn-info': acHvacMode === 'cool' }" @click="controlAC('set_mode', 'cool')">
                                            <icon-component name="cool" size="20"/>
                                            <span class="ac-mode-label">制冷</span>
                                        </button>
                                        <button class="btn btn-md btn-secondary" :class="{ 'btn-danger': acHvacMode === 'heat' }" @click="controlAC('set_mode', 'heat')">
                                            <icon-component name="heat" size="20"/>
                                            <span class="ac-mode-label">制热</span>
                                        </button>
                                        <button class="btn btn-md btn-secondary" :class="{ 'btn-warning': acHvacMode === 'fan_only' }" @click="controlAC('set_mode', 'fan_only')">
                                            <icon-component name="fan" size="20"/>
                                            <span class="ac-mode-label">送风</span>
                                        </button>
                                        <button class="btn btn-md btn-secondary" :class="{ 'btn-primary': acHvacMode === 'dry' }" @click="controlAC('set_mode', 'dry')">
                                            <icon-component name="dry" size="20"/>
                                ...
                                <div class="ac-section">
                                    ...
                                    <div class="ac-fan-slider">
                                        <button class="btn btn-circle btn-secondary" @click="controlFan('prev')">
                                            <icon-component name="minus" size="20"/>
                                        </button>
                                        <input type="range"
                                        ...
                                        <button class="btn btn-circle btn-secondary" @click="controlFan('next')">
                                            <icon-component name="plus" size="20"/>
                                        </button>
                                    </div>
                                ...
                                <div class="ac-section ac-power-section">
                                    <button class="btn btn-lg btn-block" :class="{ 'btn-primary': acHvacMode === 'off', 'btn-danger': acHvacMode !== 'off' }" @click="acHvacMode === 'off' ? controlAC('set_mode', 'cool') : controlAC('turn_off')">
                                        <icon-component name="power" size="24"/>
                        ...
                        <div v-if="popupContent === 'printer-power'" class="printer-power-popup">
                            ...
                            <!-- 按钮组 - 根据电源状态显示不同按钮 -->
                            <div class="printer-power-buttons" style="display: flex; gap: 16px; justify-content: center; margin-top: 20px;">
                                <button class="btn btn-md btn-secondary" @click.stop="closePopup()">
                                    取消
                                </button>
                                <!-- 电源关闭时显示绿色开机按钮 -->
                        ...
                        <div v-if="popupContent === 'feeder-settings'" class="feeder-settings-popup">
                            ...
                            <div class="feeder-amount-section">
                                ...
                                <div class="feeder-amount-control">
                                    <button class="btn btn-circle btn-secondary" @click="feederAmount = Math.max(1, feederAmount - 1)">
                                        <icon-component name="minus" size="20"/>
                                    </button>
                                    <span class="feeder-amount">{{ feederAmount }}</span>
                                    <button class="btn btn-circle btn-secondary" @click="feederAmount = Math.min(10, feederAmount + 1)">
                                        <icon-component name="plus" size="20"/>
                                    </button>
                                </div>
                                <input type="range"
                            ...
                            <div class="feeder-buttons">
                                <button class="btn btn-lg btn-secondary" @click.stop="closePopup()">
                                    取消
                                </button>
                                <button class="btn btn-lg btn-warning" @click.stop="confirmFeederSettings()">
                                    确定
                                </button>
                            </div>
                        </div>
                        ...
                        <div v-if="popupContent === 'washing-machine'" class="washing-machine-popup">
                            ...
                            <div class="washing-machine-params">
                                <div class="washing-machine-param">
                                    ...
                                    <div class="param-control">
                                        <button class="btn btn-circle btn-secondary" @click="adjustRinse(-1)">
                                            <icon-component name="minus" size="20"/>
                                        </button>
                                ...
                                <div class="washing-machine-param">
                                    ...
                                    <div class="param-control">
                                        <button class="btn btn-circle btn-secondary" @click="adjustWater(-10)">
                                            <icon-component name="minus" size="20"/>
                                        </button>
                            ...
                            <div class="washing-machine-controls">
                                <button class="btn btn-md btn-secondary"
                                        :class="{ 'btn-danger': washingMachinePower === 'on' }"
                            ...
                            <div class="washing-machine-childlock">
                                ...
                                <button class="btn btn-sm btn-secondary"
                                        :class="{ 'btn-danger': washingMachineChildLock }" 
                            ...
                            <!-- 关闭按钮 -->
                            <button class="btn btn-md btn-secondary btn-block" @click.stop="closePopup()">
                                关闭
                            </button>
                        </div>
                    </card-popup>
